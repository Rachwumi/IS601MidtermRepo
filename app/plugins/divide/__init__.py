...
class DivideCommand(Command):
    def execute(self):
        ...
        try:
            ...
            result = Calculator.divide( Decimal(i1), Decimal(i2) , 'divide')
            logging.info(f"The value of {i1} / {i2} is equal to {result}")
            print(f"The value of", i1, "/",i2, "is equal to",result)
        except Exception as e:
            logging.error('Please type in Decimal or Integer format: 2.0, 1.5, 18, and your second decimal can not be 0.0. %s', repr(e))
